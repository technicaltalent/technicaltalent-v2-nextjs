...
async function verifyAuthToken(request: NextRequest) {
  ...
  try {
    ...
    console.log(`🔑 [assigned/jobs] Using ${verificationResult.tokenType} token for user: ${decoded.user_email}`)
    ...
    console.error('❌ [assigned/jobs] Token verification error:', error)
    return null
  }
}
